...
* [Unbiased Scene Graph Generation from Biased Training](https://arxiv.org/pdf/2002.11949.pdf) - Kaihua Tang  _et al_, `CVPR 2020`. 
* [Weakly Supervised Visual Semantic Parsing](https://arxiv.org/abs/2001.02359) - Alireza Zareian  _et al_, `CVPR 2020`. 
* [GPS-Net: Graph Property Sensing Network for Scene Graph Generation](https://arxiv.org/abs/2003.12962) - Xin Lin  _et al_, `CVPR 2020`. 
...
* [Sketching Image Gist: Human-Mimetic Hierarchical Scene Graph Generation](https://link.springer.com/chapter/10.1007%2F978-3-030-58601-0_14) - Wenbin Wang _et al_, `ECCV 2020`.
* [Learning Visual Commonsense for Robust Scene Graph Generation](https://arxiv.org/abs/2006.09623) - Alireza Zareian _et al_, `ECCV 2020`.
* [Bridging Knowledge Graphs to Generate Scene Graphs](https://arxiv.org/abs/2001.02314) - Alireza Zareian  _et al_, `ECCV 2020`. 
...
* [Exploring the Hierarchy in Relation Labels for Scene Graph Generation](https://arxiv.org/abs/2009.05834) - Yi Zhou  _et al_, `ARXIV 2020`.
* [CogTree: Cognition Tree Loss for Unbiased Scene Graph Generation](https://arxiv.org/abs/2009.07526) - Jing Yu  _et al_, `ARXIV 2020`.

#### 2019
* [Large-Scale Visual Relationship Understanding](https://arxiv.org/abs/1804.10660) - Ji Zhang  _et al_, `AAAI 2019`. 
* [Learning to Compose Dynamic Tree Structures for Visual Contexts](https://arxiv.org/abs/1812.01880) - Kaihua Tang  _et al_, `CVPR 2019 Oral`. 
...
* [On Exploring Undetermined Relationships for Visual Relationship Detection](https://arxiv.org/abs/1905.01595) - Yibing Zhan  _et al_, `CVPR 2019`. 
...
* [The Limited Multi-Label Projection Layer](https://arxiv.org/abs/1906.08707) - Brandon Amos  _et al_, `arXiv 2019`.
...
* [Scene Graph Prediction with Limited Labels](https://arxiv.org/abs/1904.11622) - Vincent S. Chen _et al_, `ICCV 2019`. 
* [Graphical Contrastive Losses for Scene Graph Parsing](https://arxiv.org/abs/1903.02728) - Ji Zhang _et al_, `CVPR 2019`. 
...
* [LinkNet_Relational Embedding for Scene Graph](https://arxiv.org/abs/1811.06410v1) - Sanghyun Woo  _et al_, `NIPS 2018`.  
...
* [Factorizable Net: An Efficient Subgraph-based Framework for Scene Graph Generation](https://arxiv.org/abs/1806.11538) - Yikang Li  _et al_, `ECCV 2018`. 
* [Neural Motifs_Scene Graph Parsing with Global Context](https://arxiv.org/abs/1711.06640) - Rowan Zellers  _et al_, `CVPR 2018`.
* [Zoom-Net: Mining Deep Feature Interactions for Visual Relationship Recognition](https://arxiv.org/abs/1807.04979) - Guojun Yin  _et al_, `ECCV 2018`. 
...
* [Tensorize, Factorize and Regularize: Robust Visual Relationship Learning](http://openaccess.thecvf.com/content_cvpr_2018/papers/Hwang_Tensorize_Factorize_and_CVPR_2018_paper.pdf) - Seong Jae Hwang _et al_, `CVPR 2018`. 
* [Representation Learning for Scene Graph Completion via Jointly Structural and Visual Embedding](https://www.ijcai.org/proceedings/2018/132) - Hai Wan _et al_, `IJCAI 2018`.
...
* [Visual Relationship Detection with Deep Structural Ranking](http://www.jdl.link/doc/2011/20191720205091168_aaai18_small.pdf) - Kongming Liang _et al_, `AAAI 2018`.
* [Mapping Images to Scene Graphs with Permutation-Invariant Structured Prediction](https://arxiv.org/abs/1802.05451) - Roei Herzig _et al_, `NIPS 2018`. 
...
* [Context-Dependent Diffusion Network for Visual Relationship Detection](https://arxiv.org/abs/1809.06213) - Zhen Cui _et al_, `ACM MM 2018`.
* [Scene Graph Generation via Conditional Random Fields](https://arxiv.org/abs/1811.08075) - Weilin Cong _et al_, `arXiv 2018`.

#### 2017
* [Scene Graph Generation by Iterative Message Passing](https://arxiv.org/abs/1701.02426) - Danfei Xu _et al_, `CVPR 2017`.
* [Scene Graph Generation from Objects, Phrases and Region Captions](https://arxiv.org/abs/1707.09700) - Yikang Li  _et al_, `ICCV 2017`.  
...
#### 2016 and before
* [Visual Relationship Detection with Language Priors](https://arxiv.org/abs/1608.00187) - Cewu Lu _et al_, `ECCV 2016 Oral`. 
